...
import isOfficeScene from '../assets/3d/office.glb'
  ...
  return (
    <a.group ref={officeRef} {...props}>
      <a.group rotation={[-Math.PI / 2, 0, 0]}>
        <a.group rotation={[Math.PI / 2, 0, 0]}>
          <a.group position={[40.574, 19.542, 8.922]} rotation={[-Math.PI / 2, 0, 0]}>
            <mesh 
          ...
          <a.group position={[69.022, 39.481, 21.318]} rotation={[-Math.PI / 2, 0, 0]} scale={1.565}>
            <mesh
